  ...
  return (
    ...
    // branch Hotfix
        ...
        <main className=" h-full w-full flex">
          ...
          <section className=" h-full w-full md:w-5/6 md:max-w-[1200px] md:h-auto md:m-auto md:flex md:shadow-2xl rounded-3xl">

            <article className="w-full h-auto pb-3  bg-gradient-to-b from-indigo-500 to-blue-700 text-white text-center rounded-b-3xl  md:w-2/4 md:min-h-full md:rounded-3xl md:h-auto">
            ...
            <article className="mx-7 md:w-2/4">
              ...
              <div className="bg-red-100 p-4% rounded-lg flex justify-between mb-3 md:p-3">
                ...
                <div className="inline md:text-2xl">
                  80 / 100
                </div>
              </div>
              <div className="bg-yellow-100 rounded-lg p-4% my-5%  md:p-3 md:my-3">
              ...
              <div className="flex bg-green-100 p-4% mb-2 rounded-lg justify-between md:p-3">
                <div>
              ...
              <div className="bg-indigo-100 flex rounded-xl my-5% m p-4% justify-between md:p-3 md:my-3">
                <div>
            ...
            <div className="text-center">
              ...
              <button className="w-full bg-blue-950 text-white py-3 mt-4 rounded-full capitalize hover:bg-indigo-600 md:py-5 md:my-5">continue</button>
            </div>
            </article>
          </section>
        </main>
